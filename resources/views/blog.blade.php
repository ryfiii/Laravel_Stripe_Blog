<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-width-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg my-8 mx-auto p-6 max-w-4xl">
                <div class="text-gray-700">
                    ...
                    <div class="prose p-9 mx-auto" style="max-width: 800px;">
                        {!! $blog["content"] !!}
                    </div>
                </div>
            </div>
